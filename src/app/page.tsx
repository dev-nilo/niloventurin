...
import { Home as HomeIcon, User, Briefcase, FolderGit2, MessageSquare } from "lucide-react";
...
const SECTIONS_CONFIG: NavItem[] = [
    ...
    { id: "services", label: "Services", component: <Services />, icon: Briefcase },
    { id: "repositories", label: "Repositories", component: <Repositories />, icon: FolderGit2 },
    { id: "contact", label: "Contact", component: <Contact />, icon: MessageSquare },
];

export default function Home() {
    const { currentSection, setCurrentSection } = useNavigationController(SECTIONS_CONFIG.length);
