    ...
    <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center h-full">
      <div className="space-y-6 max-h-full overflow-y-auto no-scrollbar pr-2">
        ...
        <p className="text-base md:text-lg text-zinc-600 dark:text-zinc-400 leading-relaxed">
          Over 3 years of experience in the JavaScript/TypeScript ecosystem, I
          specialize in developing end-to-end web applications, focusing on
          performance, clean architecture, and responsive interfaces. I also
          bring a solid 5-year background in the TOTVS ecosystem (RM and
          Protheus), managing ERP implementation, system maintenance, access
        ...
        <div className="space-y-4">
          <div>
            ...
            <p className="text-zinc-600 dark:text-zinc-400 leading-relaxed text-sm md:text-base">
              Interface development with React and Next.js, utilizing
              TailwindCSS and Figma. Focus on UI/UX, accessibility, and
              performance optimization (Lighthouse/SEO).
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-zinc-600 dark:text-zinc-400 leading-relaxed text-sm md:text-base">
              Building scalable REST APIs with Node.js. Implementation of secure
              authentication, MVC architecture and PostgreSQL database
              management (SQL, Migrations).
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-zinc-600 dark:text-zinc-400 leading-relaxed text-sm md:text-base">
              TDD practices with Jest and CI/CD pipeline configuration (GitHub
              Actions). Experience with Docker for containerization and
              serverless deployment (Vercel).
            </p>
          </div>
        </div>

        <div className="grid grid-cols-2 gap-4 pt-4 pb-20 md:pb-0">
