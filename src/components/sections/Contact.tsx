...
export const Contact = () => (
    <div className="max-w-4xl mx-auto h-full flex flex-col justify-center items-center text-center px-6 relative">
        <div className="mb-10">
            ...
            <p className="text-lg text-zinc-600 dark:text-zinc-400 max-w-xl mx-auto mb-10">
                ...
                Send me an email and let's create something amazing.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <NeoButtonOutline href="https://linkedin.com" className="text-lg px-8 py-4">
                    <Linkedin className="mr-2" /> LinkedIn
                </NeoButtonOutline>
            </div>
        </div>

        <div className="absolute bottom-24 lg:bottom-10 left-0 w-full flex flex-col items-center gap-4">
