    ...
    <div className="max-w-6xl mx-auto h-full flex flex-col justify-center px-6">
        <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
            <div>
                ...
                <p className="text-zinc-600 dark:text-zinc-400 max-w-lg">
                    A selection of my recent open-source work. Check out my GitHub for more.
                </p>
            </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {REPOS_DATA.map((repo, index) => (
                <NeoCard key={index} className="group cursor-pointer hover:border-cyan-500 transition-colors">
                    <div className="flex justify-between items-start mb-4">
                        ...
                        <ExternalLink size={18} className="text-zinc-400 group-hover:text-cyan-500 transition-colors" />
                    </div>
