    ...
    return (
        <div className="fixed bottom-6 left-1/2 -translate-x-1/2 z-50 w-auto px-4 max-w-full">
            <motion.div
                ...
                className="flex items-end gap-3 px-4 py-3 rounded-2xl bg-white/70 dark:bg-zinc-900/70 backdrop-blur-xl border border-zinc-200 dark:border-zinc-800 shadow-2xl overflow-x-auto no-scrollbar"
            >
                ...
                <DockIcon mouseX={mouseX} onClick={() => window.open("https://github.com", "_blank")}>
                    <Github className="w-5 h-5" />
                </DockIcon>

                <DockIcon mouseX={mouseX} onClick={() => window.open("https://linkedin.com", "_blank")}>
